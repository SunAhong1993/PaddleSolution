...
【注意】默认提供的安装包需要计算机支持AVX指令集和MKL，如果您的环境不支持，请在[PaddlePaddle官网](https://www.paddlepaddle.org.cn/documentation/docs/zh/1.5/beginners_guide/install/Tables.html/#ciwhls-release)下载openblas版本的安装包          
在命令行中执行下述命令
```cmd
# 进入创建好的Anaconda环境
